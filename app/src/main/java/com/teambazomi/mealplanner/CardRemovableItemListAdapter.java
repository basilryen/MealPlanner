...
class CardRemovableItemListAdapter<T> extends RecyclerView.Adapter<CardRemovableItemListAdapter.ViewHolder> implements ItemTouchHelperAdapter{
    ...
    CardRemovableItemListAdapter(List<Object> items) {
        mDataset = items;
    }
    ...
    @Override
    public CardRemovableItemListAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                      int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                //////IN case of bug, Basil Changes this from recipe_list_item so that the cardview styles don't apply,
                .inflate(R.layout.recipe_list_item, parent, false);

        return new CardRemovableItemListAdapter.ViewHolder(v);
    }

    @Override
    public void onBindViewHolder(CardRemovableItemListAdapter.ViewHolder holder, int position) {
